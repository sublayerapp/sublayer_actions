...
# This action allows for integration with Jira, enabling automated updates and communication within workflows.
#
# Requires: 'jira-ruby' gem
# $ gem install jira-ruby
# Or add `gem 'jira-ruby'` to your Gemfile
#
# It is initialized with an issue_key and the comment_body.
# It returns the id of the created comment.
#
