...
#
# It is initialized with sender email, recipient email, subject, and body.
# It returns the response code to confirm the message was sent successfully.
#
# Example usage: When you want to send a notification or update from an AI process to a user.
